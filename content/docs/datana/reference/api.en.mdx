...
The public API serves **published** records of **public** collections. Most apps use the [`@sawala/datana-client`](/en/docs/general-concepts/cli-and-sdk) SDK; this page documents the underlying HTTP surface.
...
Send an [API key](/en/docs/general-concepts/api-keys-and-access) in the `X-API-Key` header:
...
For task-oriented examples, see [How to query records](/en/docs/datana/how-to-query-records).
