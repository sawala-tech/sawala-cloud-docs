...
Datana is for **data**, where [Kontena](/id/docs/kontena/what-is-kontena) is for **editorial content**:
...
Datana uses the same [API key](/id/docs/general-concepts/api-keys-and-access) model as the rest of the platform, with two tiers:
...
See [CLI & SDKs](/id/docs/general-concepts/cli-and-sdk) for all the developer tools, and [API keys & access](/id/docs/general-concepts/api-keys-and-access) for the key model.
