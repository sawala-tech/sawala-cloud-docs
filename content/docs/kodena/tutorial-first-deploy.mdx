...
In this tutorial you'll deploy a working site to Kodena and get a public URL. Budget about ten minutes. You'll need a Sawala Cloud account, a [project](/id/docs/general-concepts/organizations-and-projects), and **Node ≥ 20**.
...
`kodena login` opens your browser to authorize — there's nothing to copy or paste. (Headless? See [CLI & SDKs](/id/docs/general-concepts/cli-and-sdk).)
...
<Callout type="info">
Already have a project? Skip the scaffold. Just add a `kodena.json` with a `slug`, build your bundle, and deploy — see the [CLI reference](/id/docs/kodena/reference/cli).
</Callout>
...
- [Add a custom domain](/id/docs/kodena/how-to-custom-domain) — serve your site on your own hostname.
- [CLI reference](/id/docs/kodena/reference/cli) — every command, deploy flag, and `kodena.json` option.
