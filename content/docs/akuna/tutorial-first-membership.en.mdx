...
**Prerequisite:** your project needs an active **Akuna connection** to a Clerk application. If you haven't set that up, do [Connect your Clerk app](/en/docs/akuna/how-to-connect-clerk) first.
...
- [Connect your Clerk app](/en/docs/akuna/how-to-connect-clerk) — set up the connection and the member-sync webhook.
- [API reference](/en/docs/akuna/reference/api) — the `/config` endpoint and the package's exports.
