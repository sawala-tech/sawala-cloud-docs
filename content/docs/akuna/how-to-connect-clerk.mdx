...
Akuna doesn't replace authentication — it wraps **your** Clerk application. A **connection** links one Clerk app to a Sawala scope (a project, or the whole organization). Once it's in place, the [embed](/id/docs/akuna/tutorial-first-membership) can boot sign-in and new members mirror into your directory.
...
With the connection active, add the [embed](/id/docs/akuna/tutorial-first-membership) to your site with a publishable API key. See the [API reference](/id/docs/akuna/reference/api) for the config endpoint and the package exports.
