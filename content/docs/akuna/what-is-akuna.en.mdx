...
The embed reads its configuration from the [public API](/en/docs/general-concepts/api-keys-and-access) using a Sawala [API key](/en/docs/general-concepts/api-keys-and-access) scoped for Akuna:

```bash
npm install @sawala/akuna-react
```

Akuna is built to be consumed by other Sawala products too — for example, to gate learners in [Kelasna](/en/docs/kelasna/what-is-kelasna).
