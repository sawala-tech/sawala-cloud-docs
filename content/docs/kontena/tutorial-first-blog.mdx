...
3. Add fields:
   ...
   - `coverImage` — **media** (managed by [Berkasna](/id/docs/berkasna/what-is-berkasna))
   - `publishedDate` — **date**
4. Save the schema.
...
A public key is read-only and safe to ship to a browser. For the full model, see [how to mint an API key](/id/docs/kontena/how-to-mint-api-key).
...
- Read [how to mint an API key](/id/docs/kontena/how-to-mint-api-key) for the full public-vs-secret model.
- Browse all endpoints and parameters in the [API reference](/id/docs/kontena/reference/api).
- Learn the SDK across products in [CLI and SDK](/id/docs/general-concepts/cli-and-sdk).
