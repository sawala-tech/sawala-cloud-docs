...
See [how to mint an API key](/id/docs/kontena/how-to-mint-api-key).
...
See [CLI and SDK](/id/docs/general-concepts/cli-and-sdk) for installation and the wider SDK surface.
