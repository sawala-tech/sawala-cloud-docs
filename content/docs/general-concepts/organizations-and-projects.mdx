...
<Callout type="info">
Project isolation is enforced everywhere — in the dashboard and in the APIs. API requests carry the project they act on, so a key minted for one project can never read another project's data. See [API keys & access](/id/docs/general-concepts/api-keys-and-access).
</Callout>
...
Next: see what each product does in the [Products overview](/id/docs/general-concepts/products-overview).
