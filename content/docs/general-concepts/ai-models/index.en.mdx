...
| Gemma 4 26B | Google | 256K tokens | `$` | All |
...
**Are you answering customers at volume?** Start with your surface's [default](#default-models) and change it only when you have a reason — it is a cheap, capable, well-exercised starting point.
