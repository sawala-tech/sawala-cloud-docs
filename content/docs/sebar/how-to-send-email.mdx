...
with an [API key](/id/docs/general-concepts/api-keys-and-access) in `X-API-Key`. Send from your server. The recipes below cover the common variations.
...
See the [API reference](/id/docs/sebar/reference/api) for the complete request body and status list.
