...
<Callout type="info">
**Prerequisites.** A Berkasna **secret** API key (`sk_live_…`), used from a server. The upload-slot and complete steps reject publishable keys with `403 SECRET_KEY_REQUIRED`. See [API keys and access](/id/docs/general-concepts/api-keys-and-access).
</Callout>
...
- See [how to upload a public file](/id/docs/berkasna/how-to-upload-public-file).
- Read the [API reference](/id/docs/berkasna/reference/api).
