...
- You manage media alongside structured content in [Kontena](/id/docs/kontena/what-is-kontena) and want both backed by the same platform.
...
Schema fields of type `media` in [Kontena](/id/docs/kontena/what-is-kontena) are wired directly to Berkasna, so images and documents you reference in an entry are stored and served by the same platform.
...
Continue to the [first upload tutorial](/id/docs/berkasna/tutorial-first-upload).
