...
<Callout type="warn">
Placing, unplacing, or moving an item between boards **clears its board-scoped details** — its [labels](/id/docs/tugasna/how-to-labels-and-tags) and any custom-field values — because those belong to the board it came from. Things that should follow an item everywhere belong on a **tag**, not a label. [Tags](/id/docs/tugasna/how-to-labels-and-tags) survive every move.
</Callout>
...
Next: [Labels vs tags](/id/docs/tugasna/how-to-labels-and-tags).
