...
Tugasna organizes work into **boards** with Kanban columns. In this short walkthrough you'll create a board, add a few items, and move them across columns as the work progresses. Everything happens in the dashboard — there's nothing to install. You'll need a Sawala Cloud account and a [project](/id/docs/general-concepts/organizations-and-projects).
...
- [Plan with the backlog](/id/docs/tugasna/how-to-backlog) — park ideas before they hit a board.
- [Labels vs tags](/id/docs/tugasna/how-to-labels-and-tags) — the two ways to categorize items, and when to use each.
